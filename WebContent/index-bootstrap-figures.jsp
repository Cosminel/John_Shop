	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index-bootstrap-figures.jsp">John's shop</a>
            </div>
               	...
               	<div class="row">
                	...
                	<div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <img src="<%=prod.getImagePath() %>" alt=""> <!-- prod.getImage(), daca aveti -->
                            <div class="caption">
                                ...
                                <p><%=prod.getDescription() %></p> <!-- prod.getDescription(), daca aveti implementat -->
                               
                            </div>
                         	
                         	<input  type="button" class="btn btn-success btn-block" value='Adauga'>
